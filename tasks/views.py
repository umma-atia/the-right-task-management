...
update_task_decorators = [login_required, permission_required(
    "tasks.change_task", login_url='no-permission')]
...
delete_task_decorators = [login_required, permission_required(
    "tasks.delete_task", login_url='no-permission')]
...
task_detail_decorators = [login_required, permission_required(
    "tasks.view_task", login_url='no-permission')]
